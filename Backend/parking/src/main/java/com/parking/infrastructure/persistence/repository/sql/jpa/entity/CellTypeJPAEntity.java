...
@Entity
@Table(name = "TipoCelda")
public final class CellTypeJPAEntity {
	
	@Id
	@Column(name = "id_tipo_celda")
    private UUID id;
	
	@Column(name = "nombre_tipo_celda")
    private String name;
    ...
    public CellTypeJPAEntity(final UUID id, final String name, final String description, final boolean active) {
        setId(id);
        setName(name);
