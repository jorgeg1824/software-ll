...
public final class CellTypeEntity {
    ...
    public CellTypeEntity(final UUID id, final String name, final String description, final boolean active) {
        setId(id);
        setName(name);
